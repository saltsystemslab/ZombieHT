...
out_dir="sponge/$(date +%s)_gzhm_external_98_${latency}_$1"
...
for VARIANT in "${VARIANTS[@]}"; do
  ...
  cmake . -B${build_dir}/$VARIANT -DCMAKE_BUILD_TYPE=Release -DVARIANT=$VARIANT ${qf_bits_per_slot} -DPTS=2.5 -DABSL_REBUILD=0.99
