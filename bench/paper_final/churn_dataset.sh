...
if [ $1 -eq 0 ]; then
  run_args="-k 64 -q 8 -v 0 -w 10 -l 200 -i 95 -s 0 -t 1 -g 50"
  qf_bits_per_slot="-DQF_BITS_PER_SLOT=8"
elif [ $1 -eq 1 ]; then
  run_args="-k 64 -q 22 -v 0 -w 41943 -l 838860 -i 95 -s 0 -t 1 -g 50"
...
out_dir="sponge/gzhm_variants${latency}_$1_$4"
...
for VARIANT in "${VARIANTS[@]}"; do
  ...
  numactl -N 0 -m 0 ./${build_dir}/$VARIANT/hm_churn $run_args $churn_args -d ${run_dir}/$VARIANT/ -e data/$4
done
