#!/bin/bash
#run_args="-k 38 -q 22 -v 0 -c 50 -w 41943 -l 838860 -i 95 -s 1 -t 1 -m 0 -g 50 -z50"
run_args="-k 59 -q 27 -v 0 -c 50 -w 1342100 -l 26843500 -i 95 -s 1 -t 1 -m 0 -g 50 -z 50"

if [ -z "$1" ]; then
    out_dir="paper/gzhm_external_latency"
else
    out_dir="$1"
fi
